...
export default function TrainingDataUpdateDialog({
  open,
  trainingDataName = '',
  ...
  return (
    <Dialog open={open} onClose={onCancel} fullWidth>
      <DialogTitle sx={{ textAlign: 'center' }}>
        <Typography variant="h4">{t('updateTrainingData')}</Typography>
      </DialogTitle>
      <DialogContent>
        <Stack
        ...
        >
          <Stack spacing={2} width="100%">
            ...
            <DragAndDropForm
              ...
              acceptedFileTypes={['text/plain', 'application/json', '.csv']}
            />
